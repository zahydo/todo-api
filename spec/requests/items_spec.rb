...
RSpec.describe "Items API", type: :request do
  ...
  describe "GET /todos/:todo_id/items/:id" do
    before { get todo_item_path(todo_id, item_id) }
  ...
  describe "POST /todos/:todo_id/items" do
    let(:valid_attributes) { { name: 'Make the force', done: false } } 
    ...
    context "when the request attributes are not valid" do
      before { post todo_items_path(todo_id), params: {} }
  ...
  describe "PUT /todos/:todo_id/items/:id" do
    let(:valid_attributes) {{name: 'Anakin'}}
    before { put todo_item_path(todo_id, item_id), params: valid_attributes }
  ...
  describe "DELETE /todos/:todo_id/items/:id" do
    before { delete todo_item_path(todo_id, item_id) }
